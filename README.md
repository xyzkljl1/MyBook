...
- **IBKR:** daily CSV email reports and local initial reports, including transactions, holdings, dividends, interest, fees and valuation changes. Cash movements and balances retain their original currencies; deposits, withdrawals, interest, dividends and taxes retain individual statement entries. Currency balances and base-currency totals are both checked. Currency conversions without individual execution details are rejected.
