...
CREATE TABLE `statementimports` (
  `Id` int NOT NULL AUTO_INCREMENT,
  `provider` enum('IBKRReportMail','ICBCBillMail','BOCBillMail','ICBCHistoryDetailMail','ICBCSIMSMS','BOCSIMSMS','WiseMail','NexusDpMonthlyReport','KrakenApi','EthereumApi','PayPalMail','Manual','IFastMail','ZAMail','FirstTradeApi','SchwabReportMail','PlaidSchwab','PlaidWise','WiseApi') NOT NULL DEFAULT 'Manual',
...
CREATE TABLE `records` (
  ...
  `_Currency_t` enum('RMB','USD','JPY','SGD','HKD','GBP','EUR') NOT NULL DEFAULT 'RMB',
