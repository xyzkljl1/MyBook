...
CREATE TABLE `statementimports` (
  `Id` int NOT NULL AUTO_INCREMENT,
  `provider` enum('IBKRReportMail','ICBCBillMail','BOCBillMail','ICBCHistoryDetailMail','ICBCSIMSMS','BOCSIMSMS','WiseMail','NexusDpMonthlyReport','KrakenApi','EthereumApi','PayPalMail','Manual','IFastMail') NOT NULL DEFAULT 'Manual',
